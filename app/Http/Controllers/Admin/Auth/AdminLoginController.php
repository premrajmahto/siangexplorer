...
class AdminLoginController extends Controller
{
    ...
    public function sendResetLinkEmail(Request $request)
    {
        ...
        if ($admin) {
            ...
            // Dynamically force reliable SSL SMTP settings
            ...
            \Illuminate\Support\Facades\Config::set('mail.mailers.smtp.username', 'booking.siangholidays@gmail.com');
            \Illuminate\Support\Facades\Config::set('mail.mailers.smtp.password', 'fcpdoijtnvskeugp');
            \Illuminate\Support\Facades\Config::set('mail.from.address', 'booking.siangholidays@gmail.com');
            \Illuminate\Support\Facades\Config::set('mail.from.name', 'SiangExplorer');
            ...
            try {
                \Illuminate\Support\Facades\Mail::html(
                    ...
                    function ($mail) use ($targetEmail) {
                        $mail->from('booking.siangholidays@gmail.com', 'SiangExplorer')
                            ->to($targetEmail)
        ...
        return back()->with('status', 'A password reset link has been dispatched to your administrator inbox (booking.siangholidays@gmail.com). Direct reset link: ' . ($resetUrl ?? ''));
    }
