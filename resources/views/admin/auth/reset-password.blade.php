...
<head>
    ...
    <title>Set New Password | SiangExplorer Admin</title>
...
<body class="h-full flex items-center justify-center p-4 bg-gradient-to-br from-slate-950 via-slate-900 to-teal-950">
    <div class="w-full max-w-md bg-white/95 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/20">
        ...
        <div class="text-center mb-6">
            ...
            @endif
            <h2 class="text-xl font-bold text-slate-900 mt-2">Create New Password</h2>
            <p class="text-xs text-slate-500 mt-1">Please enter your email and set your new admin password.</p>
        </div>
        ...
        <form action="{{ route('admin.password.update') }}" method="POST" class="space-y-5">
            ...
            <div>
                <label for="password" class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1">New Password</label>
                <div class="relative">
            ...
            <div>
                <label for="password_confirmation" class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1">Confirm New Password</label>
                <div class="relative">
                    <i class="fa-solid fa-lock-keyhole absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 text-sm"></i>
                    <input type="password" 
