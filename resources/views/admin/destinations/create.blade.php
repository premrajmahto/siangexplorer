...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">Add New Destination</h1>
        <p class="text-xs text-slate-500 font-medium mt-0.5">Create travel destination entry for tour packages.</p>
    </div>
...
<form action="{{ route('admin.destinations.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 max-w-4xl">
    @csrf
    ...
    <div class="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g. Manali & Solang Valley" class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-500">
            ...
            <div>
                ...
                <input type="text" name="country" id="country" value="{{ old('country', 'India') }}" required placeholder="e.g. India" class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-500">
            ...
            <div>
                ...
                <input type="text" name="state_region" id="state_region" value="{{ old('state_region') }}" placeholder="e.g. Himachal Pradesh" class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-500">
            </div>
            ...
            <div>
                ...
                <input type="text" name="best_time_to_visit" id="best_time_to_visit" value="{{ old('best_time_to_visit') }}" placeholder="e.g. October to June" class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-500">
            </div>
        </div>
        ...
        <div>
            ...
            <textarea name="short_description" id="short_description" rows="2" placeholder="Brief 2-3 sentence overview..." class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-500">{{ old('short_description') }}</textarea>
        </div>
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="5" placeholder="Detailed travel information, culture, history..." class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-500">{{ old('description') }}</textarea>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                <label for="cover_image" class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1">Cover Image (JPG, PNG, WEBP)</label>
            ...
            <div>
                ...
                <input type="text" name="popular_attractions" id="popular_attractions" value="{{ old('popular_attractions') }}" placeholder="e.g. Solang Valley, Rohtang Pass, Hadimba Temple" class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-500">
            </div>
        </div>
        ...
        <div>
            ...
            <textarea name="travel_info" id="travel_info" rows="3" placeholder="How to reach, nearest airport, local transport..." class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-500">{{ old('travel_info') }}</textarea>
        </div>
    ...
    <div class="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" name="seo_title" id="seo_title" value="{{ old('seo_title') }}" placeholder="Custom meta title for Google search" class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-500">
            </div>

            <div>
                <label for="seo_keywords" class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1">SEO Keywords</label>
                <input type="text" name="seo_keywords" id="seo_keywords" value="{{ old('seo_keywords') }}" placeholder="manali tour, himachal packages, solang valley" class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-500">
            </div>
        </div>
        ...
        <div>
            ...
            <textarea name="seo_description" id="seo_description" rows="2" placeholder="Search engine snippet description..." class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-500">{{ old('seo_description') }}</textarea>
        </div>
    </div>
